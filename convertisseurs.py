...
d'encryption et de décryption de messages. Nous avons programmé ces fonctions de manière à n'utiliser que les notions
vues dans le cours jusqu'à présent (ou presque), pour que les intéressés puissent en comprendre l'implémentation.
